...
# import time
# import requests
# from streamlit_lottie import st_lottie  # Ensure this package is installed
...
# # Load a lottie animation (feel free to change the URL)
# lottie_data = load_lottieurl("https://assets2.lottiefiles.com/packages/lf20_kdx6cani.json")


# # --- Sidebar Enhancements ---
# with st.sidebar:
#     # st.image("https://img.icons8.com/external-wanicon-flat-wanicon/96/external-database-big-data-wanicon-flat-wanicon.png")
...
#     # Only display the animation if it loaded correctly
#     if lottie_data:
